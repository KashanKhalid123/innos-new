        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="Innoscribe utvikler AI-drevne løsninger som chatbots, stemmeassistenter og tilpasset programvare."
            />
            <SingleFaq
              question="Hvordan kan AI chatbots hjelpe bedriften min?"
              answer="Innoscribes chatbots gir 24/7 kundestøtte, svarer på vanlige spørsmål og automatiserer oppgaver."
            />
            <SingleFaq
              question="Hva er fordelen med en tilpasset AI-assistent? "
              answer="Det strømlinjeformer dine daglige oppgaver og integreres med din eksisterende arbeidsflyt."
            />
          </div>
